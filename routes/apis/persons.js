...
module.exports = function(app) {
    ...
    app.get('/getAllPersons', async (req, res) => {
        ...
        var query = `SELECT T0.personId,T0.firstName,T0.lastName,T0.deathRecordId,T0.createdAt,T0.updatedAt,CONCAT(T1.firstName,' ',T1.lastName) as createdBy,IFNULL(T2.estateStatus,5) as estateStatus FROM persons T0 inner join users T1 ON T0.createdBy = T1.userId left join estates T2 on T0.personId = T2.deathRecordId`;
